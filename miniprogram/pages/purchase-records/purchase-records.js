...
function decorateRecord(item) {
  return {
    ...
    plan_no_label: present(item.plan_no, t('notSet')),
    material_code_label: present(item.material_code, t('notSet')),
    category_label: present(item.category, t('notSet')),
    ...
    purchase_responsible_label: present(item.purchase_responsible, t('notSet')),
