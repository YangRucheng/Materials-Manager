...
const dictionaries = {
  [LOCALE_ZH_CN]: {
    ...
    purchaseRecordsDescription: '查看已转申购记录的采购跟踪信息',
    ...
    materialCodesTitle: '物料编码查询',
    materialCodesDescription: '查询华友物料编码库',
    ...
    huaxingInventoryDescription: '查询华星项目库存',
  ...
  [LOCALE_ID_ID]: {
    ...
    purchaseRecordsDescription: 'Lihat catatan pengadaan yang telah dipindahkan',
    ...
    materialCodesTitle: 'Cari Kode Material',
    materialCodesDescription: 'Cari di perpustakaan kode material',
    ...
    huaxingInventoryDescription: 'Cari stok proyek Huaxing',
