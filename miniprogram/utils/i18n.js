...
const dictionaries = {
  [LOCALE_ZH_CN]: {
    ...
    accountDisabledDescription: '请联系管理员启用账号后，再重新进入小程序',
  ...
  [LOCALE_ID_ID]: {
    ...
    disabledTitle: 'Akun Dinonaktifkan',
    ...
    accountDisabledDescription: 'Hubungi administrator untuk mengaktifkan akun, lalu buka kembali mini program',
