...
type ExcelImportJob struct {
	...
	CreatedAt        time.Time  `json:"created_at" gorm:"type:datetime;not null"`
	StartedAt        *time.Time `json:"started_at" gorm:"type:datetime"`
	FinishedAt       *time.Time `json:"finished_at" gorm:"type:datetime"`
...
type WebhookDelivery struct {
	...
	NextRetryAt     time.Time  `json:"next_retry_at" gorm:"type:datetime;not null"`
